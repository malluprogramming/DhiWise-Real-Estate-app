import 'package:real_estate/presentation/home_page/home_page.dart';import 'package:real_estate/presentation/message_page/message_page.dart';import 'package:real_estate/presentation/home_search_page/home_search_page.dart';import 'package:real_estate/presentation/my_home_page/my_home_page.dart';import 'package:real_estate/presentation/profile_page/profile_page.dart';import 'package:google_maps_flutter/google_maps_flutter.dart';import 'dart:async';import 'package:real_estate/widgets/custom_bottom_bar.dart';import 'models/home_listing_satelite_model.dart';import 'package:flutter/material.dart';import 'package:real_estate/core/app_export.dart';import 'provider/home_listing_satelite_provider.dart';class HomeListingSateliteScreen extends StatefulWidget {const HomeListingSateliteScreen({Key? key}) : super(key: key);

@override HomeListingSateliteScreenState createState() =>  HomeListingSateliteScreenState();

static Widget builder(BuildContext context) { return ChangeNotifierProvider(create: (context) => HomeListingSateliteProvider(), child: HomeListingSateliteScreen()); } 
 }

// ignore_for_file: must_be_immutable
class HomeListingSateliteScreenState extends State<HomeListingSateliteScreen> {Completer<GoogleMapController> googleMapController = Completer();

GlobalKey<NavigatorState> navigatorKey = GlobalKey();

@override void initState() { super.initState();NavigatorService.pushNamed(AppRoutes.homeListingDrawScreen, ); } 
